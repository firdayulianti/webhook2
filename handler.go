...
func PostBalasan(w http.ResponseWriter, r *http.Request) {
	...
	link := "https://medium.com/@yuliantifirda1007/whatsauth-free-2fa-otp-notif-whatsapp-gateway-api-gratis-287df46dcfa4"
	if r.Header.Get("Secret") == os.Getenv("SECRET") {
		if msg.Message == "loc" || msg.Message == "Loc" || msg.Message == "lokasi" || msg.LiveLoc {
			...
			dt := &wa.TextMessage{
				To:       msg.Phone_number,
				IsGroup:  false,
				Messages: "Hi kamu apa kabar" + msg.Alias_name + "\naku lagi ga ada nih \n aku firda salam kenal yaaa \n Cara penggunaan WhatsAuth ada di link berikut ini ya ka...\n" + link,
			}
			resp, _ = atapi.PostStructWithToken[atmessage.Response]("Token", os.Getenv("TOKEN"), dt, "https://api.wa.my.id/api/send/message/text")
		}
	} else {
